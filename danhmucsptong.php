                ...
                <div class="row">
                    ...
                    <div class="danhmuc-right">
                        ...
                        <?php
                            ...
                            $result = $ung->query("SELECT * FROM sach LIMIT $start, $limit");
                            if($result->num_rows > 0) {
                                while($row = $result->fetch_assoc()) {
                        ?>
                                <div class="sanpham">
                                    <img src="<?php echo $row['anhBia']; ?>" alt="<?php echo $row['tenSach']; ?>">
                                    <h1><?php echo $row['tenSach']; ?></h1>
                                    <p style="padding-top: 5px">Giá: <?php echo $row['gia']; ?> VNĐ</p>
                                    <a href="productlist.php?maSach=<?php echo $row['maSach']; ?>">Xem chi tiết</a> 
                                </div>
                        <?php
                                }
                            }
