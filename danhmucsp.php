                    ...
                    <div class="danhmuc-right">
                        <div class="danhmuc-right-content">
                            <div class="danhmuc-right-content-item">
                                <?php 
                                    if(isset($_GET['maLoaiSach'])) {
                                        $sql_sanpham = "SELECT * FROM theloaisach as t, sach as s, tacgia as ta WHERE s.maLoaiSach = t.maLoaiSach AND s.maLoaiSach='$_GET[maLoaiSach]'  AND s.maTacGia=ta.maTacGia ORDER BY s.maSach DESC";
                                ...
                                ?>
                                                <div class="sanpham">
                                                    ...
                                                    <h1><?php echo $row_sanpham['tenSach']; ?> - <?php echo $row_sanpham['tenTacGia'] ?></h1>
                                                    <p style="padding-top: 5px"><?php echo $row_sanpham['gia']; ?> VNĐ</p>
                                                    <a href="productlist.php?maSach=<?php echo $row_sanpham['maSach']; ?>" class="btn btn-primary">Xem chi tiết</a> 
                                                </div>      
                                        <?php
                                            }
                                            endwhile; 
